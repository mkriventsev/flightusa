...
(function () {
	ForceEdgeBundling = function () {
		...
		function vector_dot_product(p, q) {		//done
		...
		function initialize_edge_subdivisions() {		//done
		...
		function initialize_compatibility_lists() { 		//done
			for (var i = 0; i < data_edges.length; i++) {
		...
		function position_compatibility(P, Q) { //done
			var lavg = (edge_length(P) + edge_length(Q)) / 2.0;
			var midP = {
		...
		function edge_visibility(P, Q) { //done
		...
		function visibility_compatibility(P, Q) { //done
